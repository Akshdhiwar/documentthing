                ...
                <div className="grid gap-8 py-4">
                    <div className='grid grid-cols-5 gap-4 '>
                        <div className='col-span-3'>
                            ...
                            <a className='text-sm underline text-secondary-foreground tracking-wide' href={`https://github.com/apps/betterdocs-prod/installations/new`}>Install the Github App</a>
                        </div>
