...
export function GetStarted() {
    ...
    return (
        <div className="p-8 z-20 max-w-7xl mx-auto w-full rounded-md bg-neutral-950 relative flex flex-col items-center justify-center antialiased">
            <div className="max-w-4xl mx-auto p-4 text-center text-white">
                ...
                <Button className="z-30" onClick={() => { navigate("/account") }}>Login / Signup</Button>
            </div>
            <BackgroundBeams />
        </div>
    );
